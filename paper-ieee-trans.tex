...
\item \textbf{Integration testing}. Software components usually interact with other services while on
...
DevOps approaches, are gradually being applied as the open--source collaborative 
tools evolve, allowing tighter integrations. The Software Quality
