...
and ultimately by the Horizon 2020 programme\footnote{https://ec.europa.eu/programmes/horizon2020/} -- are being held to coordinate and 
...
evolution of the software engineering methodologies (e.g. creation of the Agile
Manifesto \cite{agile-manifesto}, rise of DevOps practices \cite{zhu}) together
with the parallel advancements in the information and communications technology (ICT)
field such as virtualization, enabling technology for Cloud computing and 
...
The INDIGO--DataCloud project is the most recent project in the list and, as such, it is 
the result of the lessons learned from previous experiences in terms of the evaluation and application
of innovative software engineering methodologies, the management of new technologies to put
them into practice, and the compilation and analysis of metrics to measure the success of the
solutions implemented. The expertise gathered is complemented by the fact of being framed in
collaborative projects with an extensive list of partners.


framed projects 

All of this with the added complexity of being framed in major
collaborations with 




procollecting and analyzing metrics relevant for the .. to empower the sw reliability bla bla bla
