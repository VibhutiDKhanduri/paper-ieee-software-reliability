...
to the resources, available for the researchers. One clear example is Worldwide
Large Hadron Collider Computing Grid (WLCG) e-Infrastructure, powered by the
Particle Physics scientific community, built up to satisfy the computing needs
of processing, storing and analysing all the data coming from the Large Hadron
Collider particle accelerator.

Years of major developments followed, mainly focused on providing the new
functionalities, hindering the adoption of software engineering methodologies.
The software delivered was by then little tested, resulting in constant
rollbacks and patches applied to production systems. Thereby, the stability and
reliability of the e-Infrastructures was deeply compromised, affecting
...
and the reliability of the software produced. Thus, a substantial part of the
software lifecycle should be devoted to deal with the quality of software being
