...
In this section, we detail the level of knowledge in delivering reliable software before and after the EC-founded projects.
We divide literature into four different domains that intersect this work. Firstly, we describe the software development process showing how the various phases reflect on software quality attributes. Next, we describe the impact of software requirements on software quality. In the last, we introduce metrics and measurements. In the last, we talk about software testing and code coverage.

\emph{Metrics and measurements.} Metrics and measurements have an important role in the software development process \cite{fenton, capers}.
...
\emph{Testing.} Testing is an important factor for software quality and reliability improvement. In literature there are many types of software testing \cite{myers} that aim at finding errors, bugs and faults during the software development process, possibly in the early stages. Test criteria focus on measuring the coverage of the test suite 
