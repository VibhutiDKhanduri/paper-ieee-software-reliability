...
the last 15 years. In particular, in this section we are primarily interested in hightlighting the 
collaborative
...
there is a positive trend of efficiency over the months, with the unique exception of the LCG--1 prototype.
\begin{figure}[h]
\centering
...
\section{INDIGO--DataCloud Software Quality Assurance Process}
\label{sec:ntsr}

{\sl INDIGO--DataCloud} project \cite{salomoni2018indigo} %is the most recent project included in this paper, it
...
As we will describe hereafter, the {\sl INDIGO--DataCloud} SQA process is not restricted to software targeted to distributed
