...
Jenkins, the event--response CI system, and Docker container
...
%\emph{DataGrid project}, European Community Research and Development Information Service (CORDIS).
%[Online] Available: \url{http://cordis.europa.eu/project/rcn/53665\_en.html}
%[Accessed 4 Jun. 2018].
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% TOBE checked if there are papers on these
...
%\emph{E--Infrastructure for Testing, Integration and Configuration of Software (ETICS)}
%project, European Community Research and Development Information Service (CORDIS).
%[Online] Available: \url{http://cordis.europa.eu/project/rcn/80138\_en.html}
%[Accessed 4 Jun. 2018].
...
%[Online]. Available: \url{http://cordis.europa.eu/project/rcn/86604\_en.html}
%[Accessed 4 Jun. 2018].
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%Research and Development Information Service (CORDIS).
%[Online] Available: \url{http://cordis.europa.eu/project/rcn/95311\_en.html}
%[Accessed 4 Jun. 2018].
...
%[Online] Available: \url{http://cordis.europa.eu/project/rcn/95923\_en.html}
%[Accessed 4 Jun. 2018].
...
%[Online] Available: \url{https://operations-portal.egi.eu/}
%[Accessed 4 Jun. 2018].
...
%[Online] Available: \url{https://ggus.eu/}
%[Accessed 4 Jun. 2018].
...
%[Online] Available: \url{https://goc.egi.eu/}
%[Accessed 4 Jun. 2018].
...
%Information Service (CORDIS).
%[Online] Available: \url{http://cordis.europa.eu/project/rcn/194882\_en.html}
%[Accessed 4 Jun. 2018].
