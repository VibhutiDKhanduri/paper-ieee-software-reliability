...
software lifecycle:
\begin{itemize}
    \item A solid \textit{Software Quality Assurance (SQA) criteria and metrics gathering definition} provides guidelines to develop quality
    ...
    process. 
    \item The \textit{promotion of automation} to enable the foregoing change--based validation approach 
    and to accelerate the delivery process of new software versions.
    \item A post-release validation carried out over the project's \textit{preview testbeds}, where the new product versions
...
development teams to act promptly based on the regular user feedback \cite{chen2015}. The software updates of
