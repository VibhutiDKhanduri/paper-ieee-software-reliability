...
%(Update: I see this is discussed later... so it would be good just to signpost at the start that a) the focus is really on "grids", and b) that specific examples will be given.
LHC particle accelerator. A significant number of innovation projects and
technology transfer activities -- from the European Commission (EC)-funded 5th, 6th and 7th Framework Programmes,
and recently from the Horizon 2020 programme \cite{h2020} -- have as their main goal to
develop software solutions that provide a seamless and transparent access of researchers to distributed
computing and data resources.

% Comment
%%top of second column:  think about saying this more gently
...
software lifecycle was devoted to the improvement of the quality of the software being
delivered. At this point, evolving software engineering practices were
considered and gradually adopted to define and implement quality procedures, the organization of cross--functional teams
...
% Comment
%%P2 C2 L24: Typographical: It would be good to merge the three citations into one bracket/\cite
...
%\includegraphics[width=0.8\textwidth]{images/fig2a.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.5\textwidth, height=50mm]{images/fig3.png}
...
of the tests, covering past fixed issues, to ensure that they are not reintroduced during the development activities.

%% Comment from reviewer
%% These percentages appear as vague approximations by eye, please add the precise numbers rounded.

 \textit{Unit testing} completes the source code testing evaluation by
focusing on the code's internal design. The SQA criteria set a recommended threshold of
70\% coverage for unit testing. In Fig.~\ref{fig:fig_unittest}, unit testing coverage is compared
...
% Comment
%%L42-44 not clear, please rephrase
...
%{\sl DataGrid - Research and Technological Development for an International Data Grid} project
%has received funding from the European Commission - Community Research and Development Information System (CORDIS) under
%FP5-IST - Programme for research, technological development and demonstration on a "User--friendly information society, 1998-2002" (IST--2000--25182E)
%{\sl EGEE - Enabling grids For E--science} project
%has received funding from the European Commission - Community Research and Development Information System (CORDIS) under
% FP6-INFRASTRUCTURES - Research infrastructures: Specific programme for research, technological development and demonstration: "Structuring the European Research Area" under the Sixth Framework Programme 2002-2006, (INFSO--RI--508833)
%{\sl EGEE - Enabling grids For E--science--II} project
% has received funding from the European Commission - Community Research and Development Information System (CORDIS) under
% FP6-2005-INFRASTRUCTURES-7 programme, Topic - "INFRASTR-3 - Communication network development in conjunction with thematic priority 2 (Information Society Technologies) to establish a high--capacity and high--speed communications network for all researchers in Europe (GEANT)", (INFSO--RI--031688)
%{\sl EGEE - Enabling grids For E--science--III} project has received funding from the European Commission - Community Research and Development Information System (CORDIS) under
%  FP7-INFRASTRUCTURES - Specific Programme "Capacities": Research infrastructures, Topic - "INFRA-2007-1.2-03 - e--Science Grid infrastructures", (INFSO--RI--222667)
