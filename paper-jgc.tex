...
Throughout the last 15 years, the European Commission (EC) has continuously invested on software development initiatives to provide
...
the last 15 years. In particular, in this section we are primarily interested in those projects that consisted in
the collaborative development of software solutions, intended for improving the accessibility and exploitation 
of distributed computing technologies by research communities within the European research
landscape. We will highlight the most representative software engineering
practices adopted within each of these projects to understand how they inspired the SQA process 
definition and implementation of {\sl INDIGO--DataCloud}. 
...
the quality and reliability of the software solutions have progressively increased. As shown in Table~\ref{tab:feat}, the most recent projects are more
...
%executed in an automated manner using the CI infrastructure. 
...
implementation of automated functional tests were releated to the unavailability
...
The application of the formerly described SQA process was not only beneficial for the
