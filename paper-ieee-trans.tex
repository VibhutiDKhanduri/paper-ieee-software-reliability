...
Figure \ref{fig:ingigobugs}
\begin{figure}[ht]
\centering
\includegraphics[width=0.5\textwidth, height=50mm]{images/indigoBugs.png}
\caption{Number of INDIGO bugs detected during the development and production phases.}
